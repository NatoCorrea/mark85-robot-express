...
Não deve cadastrar com senha com 1 digito
    [Tags]    short_pass
    Alert short password    1

Não deve cadastrar com senha com 2 digitos
    [Tags]    short_pass
    Alert short password    12

Não deve cadastrar com senha com 3 digitos
    [Tags]    short_pass
    Alert short password    123

Não deve cadastrar com senha com 4 digitos
    [Tags]    short_pass
    Alert short password    1234

Não deve cadastrar com senha com 5 digitos
    [Tags]    short_pass
    Alert short password    12345
